...
public class ClientManager
{
	...
	public static boolean RegisterChannel(Channel clientchannel)
	{
		...
		if (flag == false)
		{
			System.out.println("Error: RegisterChannel failed !");
		}
		else
		{
			System.out.println("Info: RegisterChannel Successfully!");
		}
		return flag;
	}
	...
	public static boolean UnregisterChannel(Channel clientchannel)
	{
		...
		{
			System.out.println("Info: UnregisterChannel Successfully!");
		}
		return flag;
	}
	...
	{
		System.out.println("Current Client Number:"+channelst.size());
		for (Channel channel :
				channelst)
		{
